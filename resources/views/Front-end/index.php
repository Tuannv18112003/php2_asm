            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="assets/img/bag10.jpg">
                            <div class="categories__text">
                                <h4>TÚI XÁCH</h4>
                                <a href="./shop?id=7">Shop now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="assets/img/hat1.jpg">
                            <div class="categories__text">
                                <h4>MŨ</h4>
