            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/NT SHOP.png" alt="">
                  <span class="d-none d-lg-block">NT SHOP</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Điền thông tin tài khoản của bạn</p>
                  </div>
                  ...
                  <form method="POST" action="./register" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <label for="yourRePassword" class="form-label">Nhập lại mật khẩu</label>
                      <input type="password" name="rePassword" class="form-control" id="yourRePassword" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                      <div style="color:red"><?= !empty($errorinfo['password']) ? $errorinfo['password'] : '' ?></div>
                    </div>
